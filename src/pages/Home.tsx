...
const features = [
  {
    icon: Shield,
    title: "100% sécurisé",
    description: "Vos données sont chiffrées et vous restez maître de tout.",
  },
  {
    icon: Heart,
    title: "Soulagez vos proches",
    description: "En cas d'urgence, ils auront tout ce dont ils ont besoin.",
  },
  {
    icon: Clock,
    title: "15 minutes",
    description: "C'est le temps moyen pour compléter votre passeport.",
  },
];
...
const pricingPlans = [
  {
    ...
    features: [
      "Document Passeport de Vie",
      "Guide d'utilisation complet",
      "Checklists d'urgence",
    ],
    ...
    <div className="pb-24">
      ...
      >
        ...
        >
          Votre sérénité,
          <br />
          <span className="text-navy">organisée.</span>
        </motion.h1>
        ...
        >
          Centralisez vos informations essentielles pour soulager vos proches en
          cas d'imprévu.
        </motion.p>
      ...
      >
        ...
        <div className="bg-card rounded-2xl p-5 shadow-soft">
          <p className="text-muted-foreground text-sm leading-relaxed mb-4">
            Le <strong className="text-foreground">Passeport de Vie</strong> est
            un dossier administratif d'urgence qui centralise toutes les
            informations dont vos proches auront besoin en cas :
          </p>
