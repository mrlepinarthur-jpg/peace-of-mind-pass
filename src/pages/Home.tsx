...
const pricingPlans = [
  {
    ...
    features: [
      "4 sections : Identité, Contacts, Documents, Santé",
  ...
  },
  {
    ...
    price: "1,99€",
    period: "mois",
    description: "Accédez à toutes les sections pour tout organiser sereinement.",
    features: [
      "Toutes les sections du passeport débloquées",
      "Export PDF complet",
