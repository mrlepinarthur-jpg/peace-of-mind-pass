        ...
        <div className="prose prose-sm max-w-none space-y-6 text-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              du service. En cas de suppression de compte, vos données sont effacées dans un délai 
              de 30 jours. Les données de facturation sont conservées 10 ans conformément aux 
              obligations légales.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              et sur l'exécution du contrat de service (article 6.1.b du RGPD).
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-1">
              ...
              <li><strong className="text-foreground">Droit à la portabilité :</strong> recevoir vos données dans un format structuré (export JSON disponible dans les réglages)</li>
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">7. Contact DPO</h2>
            <p className="text-muted-foreground">
              ...
              <a href="mailto:dpo@passeportdevie.fr" className="text-primary underline">dpo@passeportdevie.fr</a>
            </p>
            <p className="text-muted-foreground">
